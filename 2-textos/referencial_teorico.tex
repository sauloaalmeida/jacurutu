...
Em \textcite[37]{DissertacaoElton2015}, por utilizar uma metodologia mista, apresenta exemplos de quadro de hipóteses e de quadro de suposições. A tabela~\ref{tab:quadro_hipoteses} apresenta uma parte do quadro de hipóteses\index{quadro de hipóteses} do trabalho.
...
Ainda sobre o mesmo trabalho, a tabela~\ref{tab:quadro_suposicoes} apresenta uma parte do quadro de suposições\index{quadro de suposições}.
