%Configuração de compatibilidade longa do pdf
...
% Mais configurações sobre tabelas.
% Usados para definir o tamanho da largura da tabela na coleta capes
\usepackage{tabularx}
...
\usepackage{amsmath}
% Necessário para o ambiente definição, teorema, lemas e propriedades
\usepackage{amsthm} 
%%%%% Configuração do amsthm para o estilo de definição - INICIO
\newtheorem{theorem}{Teorema}
\newtheorem{definition}{Definição}
\newtheorem{property}{Propriedade}
%%%%% Configuração do amsthm para o estilo de definição - FIM
...
% Pacote usado para customizar formato do caption das tabelas e das figuras
\usepackage{caption}
...
\cslsetup{
	%remove a identacao da primeira linha da referencia
	bib-par-indent = 0pt
}
...
% Usado para formatar URLs no texto
\usepackage{url}
...
%%%%% Configurações de flutuantes - INICIO %%%%%%%%%%%%%%%%%%%%%%%%
% Não permite que elementos flutuantes (figuras, tabelas, etc.) fiquem em páginas sem texto, quando há espaço
