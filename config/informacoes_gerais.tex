...
\newcommand{\nomecursograduacao}[1]{\gdef\@nomecursograduacao{#1}}
...
\siglaprograma{PPGI}
\nomecursograduacao{Curso de Bacharelado em Ciência da Computação}
...
%Para texto folha de rosto de tcc. Descomentar essa, e comentar as demais variáveis \textofolharosto
%\textofolharosto{Trabalho de conclusão de curso de graduação apresentado ao \@nomeinstituto\ da \@nomeuniversidade, como parte dos requisitos para  obtenção do grau de Bacharel em Ciência da Computação.}

%Para texto folha de rosto de mestrado. Descomentar essa, e comentar as demais variáveis \textofolharosto
...
%Para texto folha de rosto de doutorado. Descomentar essa, e comentar as demais variáveis \textofolharosto
%\textofolharosto{Tese de Doutorado apresentada ao \@nomeprograma, \@nomeinstituto\ e  \@nomeinstitutoparceiro, \@nomeuniversidade, como requisito parcial à obtenção do título de Doutor em Informática.}
