...
\fancypagestyle{tituloanexoapendice}[plain]{
    \fancyhead[C]{\bfseries\uppercase{Apêndice B - Plano da revisão sistemática}}
}

% Resolvendo bug de erro de pagina no hyperref e definindo nova entrada do sumário
\phantomsection
\addcontentsline{toc}{chapter}{\MakeUppercase{Apêndice B - Plano da revisão sistemática}}
