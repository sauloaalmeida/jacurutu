...
Seguem os exemplos de itens mais comuns:
...
\begin{enumerate}
	...
	Um exemplo de lista simples pode ser criada utilizando os comandos \verb|\begin{itemize}| e \verb|\item|, como demostrado a seguir:
	...
	O Apêndice C também apresenta um formulário, onde uma lista enumerada foi utilizada para realizar a formatação de um formulário.
	...
	\begin{verbatim}
		Essa métrica é estabelecida pela equação~\eqref{eq:diferenca_percentual},
		onde \(DP\) é a Diferença Percentual, \(T_p\) é o Tempo em Paralelo
