...
\begin{document}
	...
	%Formulario de coleta do CAPES e Ficha catalográfica do documento (elemento obrigatório)
	\input{1-pre-textuais/coleta_capes_ficha_catalografica}
	...
	\input{2-textos/desenvolvimento}
	...
	\input{3-pos-textuais/apendice-a}
